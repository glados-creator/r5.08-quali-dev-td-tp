...
- Qu'est-ce qu'un test E2E ?
    - *Que veut dire E2E ?* End to End
    - *Quelles sont ses caractéristiques principales ?* tester depuis la création de l'app , a la completion d'un sénario test 
...
Cypress is comparable to Selenium.
